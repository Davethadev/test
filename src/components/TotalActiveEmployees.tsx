...
const TotalActiveEmployees = ({ searchQuery }: SearchQueryProps) => {
      ...
      >
        ...
        <TableBody className="relative h-full">
          {filteredEmployees.length === 0 ? (
            <p className="poppins-medium text-sm text-black absolute w-full h-full grid grid-cols-1 place-items-center place-content-center">
              No employees found
            </p>
          ) : (
